                ...
                <div class="card bg-base-100 shadow-xl border border-base-200">
                    <div class="card-body">
                        ...
                        <div class="flex items-center justify-between p-4 bg-base-200/50 rounded-lg mb-6">
                            ...
                            <button @click="scanAll" class="btn btn-primary" :disabled="loading">
                        ...
                        <div class="form-control mb-4">
                            <div class="flex gap-2">
                                ...
                                <button @click="openFolderPicker" class="btn btn-outline gap-2 max-w-xs">
                        ...
                        <div class="bg-base-200 rounded-box p-2 max-h-48 overflow-y-auto">
                            ...
                            <div v-else v-for="(folder, index) in settingsStore.folders" :key="index"
                                class="flex items-center justify-between p-3 hover:bg-base-100 rounded-lg transition-colors group">
                                <div class="flex items-center gap-3 overflow-hidden">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-secondary shrink-0"
            ...
            <div class="space-y-8">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-control w-full">
                            ...
                            <div class="flex gap-4 items-center">
                                ...
                                <div class="w-10 h-10 rounded-lg shadow-sm border border-base-content/10"
                ...
                <div class="card bg-base-100 shadow-xl border border-base-200">
                    <div class="card-body">
                        ...
                        <div class="form-control">
                            <label class="label">
                                <span class="label-text">Calidad de Audio</span>
                            </label>
                            <select class="select select-bordered select-sm w-full max-w-xs">
                                <option>Alta (320kbps)</option>
                                <option>Normal (128kbps)</option>
                                <option>Baja (Ahorro de datos)</option>
                            </select>
                        </div>
                    </div>
                </div>
